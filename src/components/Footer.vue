...
const socials = [
  { name: 'Twitter', url: 'https://twitter.com/kriyagni', icon: TwitterIcon },
  { name: 'LinkedIn', url: 'https://linkedin.com/company/kriyagni', icon: LinkedInIcon },
  { name: 'GitHub', url: 'https://github.com/kriyagni', icon: GitHubIcon }
];
